...
class Config(object):
    ...
    def set_dataset_dir(self):
        ...
        self.best_srho_save_dir = os.path.join(self.save_dir_root, 'best_srho_model')
        os.makedirs(self.best_srho_save_dir, exist_ok = True)
        
        self.best_ktau_save_dir = os.path.join(self.save_dir_root, 'best_ktau_model')
        os.makedirs(self.best_ktau_save_dir, exist_ok = True)
