...
#SBATCH --job-name=csta_mrhisum_visual_testing    # Submit a job named "example"
...
#SBATCH --output=/home/yejin/data/projects/yejin/VideoSum/Triplesumm/slurm_log/csta/csta_mrhisum_visual_testing.out  # 스크립트 실행 결과 std output을 저장할 파일 이름
